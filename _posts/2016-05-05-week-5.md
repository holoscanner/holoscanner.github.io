...
While there's currently a difference between our progress and the goals set in the PRD, this doesn't mean we've fallen behind on per-week goals, but instead have reordered a number of tasks as a result of simplicity in code structure. Below is a summary of modifications we've made to our goals:
